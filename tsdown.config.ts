 ...
 *
 * Uses the vendored shared client-bundle preset (build/shared/tsdown.client.ts):
 ...
 */
import { clientBundle } from './build/shared/tsdown.client.ts'

export default clientBundle('@yezack/dsh-ssh', ['src/index.ts', 'src/invariant.ts'], {
  libExternal: [
