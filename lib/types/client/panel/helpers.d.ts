 ...
 */
export declare const TERMINAL_FONT_FALLBACK = "Menlo, Consolas, \"Liberation Mono\", monospace";
/**
 ...
 */
export declare function resolveTerminalFontFamily(override?: string): string;
